...
SECRET_KEY = 'django-insecure-j5y*i7#d&b^o=ue4k^)9pxwk$i&3_g)lj2z@=#smt_y$pgn#rm'
...
CORS_ALLOWED_ORIGINS = [
    "https://instagram-clone-nuxt3.vercel.app",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    'https://nuxt.com'
]
...
AUTHENTICATION_BACKENDS = [
    'user.api.backends.CustomUserModelBackend',
